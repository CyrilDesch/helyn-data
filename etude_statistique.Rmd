...
author: "D'après Cyril Deschamps, Etienne Ducros, Hugo Brun et Lennon Herrmann / [Site du projet](https://helyn.cyrildeschamps.fr)"
date: "`r Sys.Date()`"
output:
  html_document:
    toc: true
...
### Script d'entrainement random forest (via ranger, sur plusieurs coeurs) 
```{r eval=FALSE}
# Préparation des données
df_model <- clean_data %>%
  group_by(code_bureau_vote) %>%
