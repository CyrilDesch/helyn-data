...
>>>>>>> aed9d0b (Feat : rapport regression)
```
...
df_vote <- donnees %>% select(any_of(vote_cols))
df_demo <- donnees %>% select(any_of(setdiff(names(donnees %>% select_if(is.numeric)), vote_cols2)))
...
IL ME MANQUE QUE CA, JE TOUCHE UN TRUC AU MODELE J4AI UNE IDEE
...
![](profil_type_extreme_gauche.png)
> **INTERPRETER**  
>  

![](profil_type_gauche.png)

> **INTERPRETER**  
>  

![](profil_type_centre.png)
> **INTERPRETER**  
>  

![](profil_type_droite.png)
> **INTERPRETER**  
>  

![](profil_type_extreme_droite.png)
> **INTERPRETER**  
>  
