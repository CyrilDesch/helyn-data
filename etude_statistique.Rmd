...
Le script d'extraction et de nettoyage des données est disponible ici.
...
Pour les résultats des élections, il a d'abord été nécessaire de transformer la liste des votes par candidat dans chaque bureau de vote en catégories agrégées correspondant aux principaux courants politiques : gauche, droite, centre, extrême droite, etc. Cette transformation permet de calculer des pourcentages par bureau de vote afin de comparer les tendances politiques plus facilement.  

#### TODO : LENNON PARLE DE CE QUE T'AS FAIT (lis le paragraphe au dessus)
