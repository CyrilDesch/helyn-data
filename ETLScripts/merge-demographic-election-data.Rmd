...
```{r save-data}
# Fonction pour arrondir certaines colonnes numériques et sauvegarder
arrondir_et_sauvegarder <- function(data, colonnes, filepath) {
  # Vérifier si le dataframe contient des colonnes
  if (ncol(data) == 0) {
  ...
  # Arrondir les colonnes spécifiées
  data[, colonnes_existantes] <- lapply(data[, colonnes_existantes, drop = FALSE], round)
  
  # Sauvegarder dans un fichier CSV
  write.csv(data, filepath, row.names = FALSE)
  
  cat("Fichier sauvegardé :", filepath, "\n")
}

# Liste des colonnes à arrondir
colonnes_a_multiplier <- c("Nb_25", "Nb_65", "Part_cadres")
...
# Sauvegarder les datasets avec arrondi
arrondir_et_sauvegarder(result_2010_2012, colonnes_a_multiplier, file.path(output_dir, "result_2010_2012.csv"))
arrondir_et_sauvegarder(result_2013_2017, colonnes_a_multiplier, file.path(output_dir, "result_2013_2017.csv"))
arrondir_et_sauvegarder(result_2018_2024, colonnes_a_multiplier, file.path(output_dir, "result_2018_2024.csv"))

# Afficher un aperçu final
cat("\nAperçu de result_2010_2012 final :\n")
head(result_2010_2012)

cat("\nAperçu de result_2013_2017 final :\n")
head(result_2013_2017)

cat("\nAperçu de result_2018_2024 final :\n")
head(result_2018_2024)
```