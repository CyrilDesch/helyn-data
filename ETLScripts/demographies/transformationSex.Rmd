...
head(data)
```  
## Reorganize the columns order with the new columns

We will reorganize the columns order with the new columns we added.

``` {r reorganizeColumnsWithNewColumns}

# Reorganize the columns from the names of the columns
newOrder <- c("Code Commune", "Nom Commune",
              "Population Totale", "Proportion H", "Proportion F",
              "Nb H total", "Nb F total", 
              "Nb H 15-24 ans", "Nb H 25-64 ans", "Nb H 65+ ans",
              "Nb F 15-24 ans", "Nb F 25-64 ans", "Nb F 65+ ans")
